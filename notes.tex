...
\ifx\phone1
\usepackage[centering,margin=1.5cm]{geometry}
\geometry{papersize={15cm,20cm}} 
\else
...
%    \\ \copyright Trusted Software and Intelligent System Lab., BUPT}
%\date{2020/01/21}
%\begin{figure}
%  \includegraphics[width=0.25\textwidth]{tsislogo}
%  \caption{Enjoying our time in TSIS Lab.}
%  \label{fig:tsis}
%\end{figure}
...
%	\quad\\[1.5cm]
%    \includegraphics[width=3cm]{tsislogo}
%	\textsl{\Large Beijing University of Posts and Communications }\\[0.5cm] 
%	\textsl{\large School of Computer Science}\\[0.5cm] 
%	\makeatletter
	\HRule \\[0.4cm]
  ...
  \vspace{2em}
    \center
    \includegraphics[scale=0.005]{tsislogo.jpg}\\
      \vspace{2em}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\linewidth]{firm-afl.png} %width=\linewidth
...
\section{Enhancing example-based code search with functional semantics \\@Journal of Systems and Software'20}
\subsection{Background/Problems}
...
\section{Jetset: Targeted Firmware Rehosting for Embedded Systems \\@Security'21}
\subsection{Background/Problems}
